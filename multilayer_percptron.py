...
num_entrada = 2          # numero de neuronas en la capa de salida
num_nocultas = 2        # numero de neuronas en la capa oculta
num_nsalida = 1         # numero de neuronas en la capa de salida
